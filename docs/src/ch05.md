# [第5回：■ 条件式・■ 条件分岐](@id ch05)

## ■ 数の大小比較

[Numeric Comparisons (section)](https://docs.julialang.org/en/v1.5/manual/mathematical-operations/#Numeric-Comparisons-1)
...
* [`Base.:>` - Function](hhttps://docs.julialang.org/en/v1.5/base/math/#Base.:%3E)
* [`Base.:>=` — Function](https://docs.julialang.org/en/v1.5/base/math/#Base.:%3E=)
...
* [`Base.:<` - Function](hhttps://docs.julialang.org/en/v1.5/base/math/#Base.:%3C)
* [`Base.:<=` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.:%3C=)
...
[Conditional Evaluation (section)](https://docs.julialang.org/en/v1.5/manual/control-flow/#man-conditional-evaluation-1)
...
[Conditional evaluation](https://docs.julialang.org/en/v1.5/manual/control-flow/#man-conditional-evaluation-1)
"ternary operator"
...
* [`&&` - Keyword](https://docs.julialang.org/en/v1.5/base/math/#&&)
...
[Short-Circuit Evaluation (section)](https://docs.julialang.org/en/v1.5/manual/control-flow/#Short-Circuit-Evaluation-1)
...
* [Random Numbers (section)](https://docs.julialang.org/en/v1.5/stdlib/Random/#Random-Numbers-1)
* [`Base.Random.rand` - Function](https://docs.julialang.org/en/v1.5/stdlib/Random/#Base.rand)
