...
[Integers (section)](https://docs.julialang.org/en/v1.5/manual/integers-and-floating-point-numbers/#Integers-1)
...
[Overflow behavior (section)](https://docs.julialang.org/en/v1.5/manual/integers-and-floating-point-numbers/#Overflow-behavior-1)
...
* [`Base.bitstring` — Function](https://docs.julialang.org/en/v1.5/base/numbers/#Base.bitstring)
...
* [`Base.rem` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.rem)
* [`Base.div` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.div)
...
除算例外 [Division errors (section)](https://docs.julialang.org/en/v1.5/manual/integers-and-floating-point-numbers/#Division-errors-1)
...
!!! note
    例外が発生した場合，それを救済する手続きを書いて，プログラムを続行することもできる．だが，この文書の範囲を超えるので，説明しない． → [Exception Handling](https://docs.julialang.org/en/v1.5/manual/control-flow/#Exception-Handling-1)
