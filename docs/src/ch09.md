...
### ■ 積
* [`Base.prod` — Function](https://docs.julialang.org/en/v1.5/base/collections/#Base.prod)
...
* [`LinearAlgebra.norm` — Function](https://docs.julialang.org/en/v1.5/stdlib/LinearAlgebra/#LinearAlgebra.norm)
...
* [`Statistics.mean` — Function](https://docs.julialang.org/en/v1.5/stdlib/Statistics/#Statistics.mean)
* [`Base.stdm` — Function](https://docs.julialang.org/en/v1.5/stdlib/Statistics/#Statistics.stdm)
...
* [`Base.min` — Function](https://docs.julialang.org/en/v1.5/base/math/#Base.min)
* [`Base.max` — Function](https://docs.julialang.org/en/v1.5/base/math/#Base.max)
...
* [... splits one argument into many different arguments in function calls](https://docs.julialang.org/en/v1.5/manual/faq/#...-splits-one-argument-into-many-different-arguments-in-function-calls-1)
