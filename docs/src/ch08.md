...
* [`Base.length` — Method](https://docs.julialang.org/en/v1.5/base/collections/#Base.length)
...
* [Indexing (section)](https://docs.julialang.org/en/v1.5/manual/interfaces/#Indexing-1)
...
* [`Base.zeros` — Function](https://docs.julialang.org/en/v1.5/base/arrays/#Base.zeros)
...
* [`Base.ones` — Function](https://docs.julialang.org/en/v1.5/base/arrays/#Base.ones)
...
* [`Base.Random.randn` — Function](https://docs.julialang.org/en/v1.5/stdlib/Random/#Base.randn)
...
* [`Base.sum` — Function](https://docs.julialang.org/en/v1.5/base/collections/#Base.sum)
...
* [Repeated Evaluation: Loops](https://docs.julialang.org/en/v1.5/manual/control-flow/#man-loops-1)
