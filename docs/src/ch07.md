...
* 指数関数 $y = \exp{x}, \; x = 0$
* 対数関数 $y = \log{x}, \; x = 1$
* 対数関数 $y = \log\left(1+x\right), \; x = 0 \;$ ．注: 関数 [`Base.log1p` — Function](https://docs.julialang.org/en/v1.5/base/math/#Base.log1p) を用いよ．
...
* [`Base.isapprox` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.isapprox)
...
* [`Base.isfinite` - Function](https://docs.julialang.org/en/v1.5/base/numbers/#Base.isfinite)
* [`Base.isinf` - Function](https://docs.julialang.org/en/v1.5/base/numbers/#Base.isinf)
* [`Base.isnan` - Function](https://docs.julialang.org/en/v1.5/base/numbers/#Base.isnan)
