...
`[Julia 1.1 Documentation](https://docs.julialang.org/en/v1.5/)`
...
* [`Base.cos` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.cos-Tuple{Number})
* [`Base.sin` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.sin-Tuple{Number})
...
* [`Base.Math.cospi` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.Math.cospi)
* [`Base.Math.sinpi` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.Math.sinpi)
...
* [`Base.Math.cosd` - Function](hhttps://docs.julialang.org/en/v1.5/base/math/#Base.Math.cosd)
* [`Base.Math.sind` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.Math.sind)
...
* [`Base.Math.rad2deg` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.Math.rad2deg)
* [`Base.Math.deg2rad` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.Math.deg2rad)
...
* [`Base.sqrt` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.sqrt-Tuple{Real})
...
* [`Base.Math.cbrt` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.Math.cbrt)
...
* [`Base.log` — Method](https://docs.julialang.org/en/v1.5/base/math/#Base.log-Tuple{Number})
...
* [Base.log — Method](https://docs.julialang.org/en/v1.5/base/math/#Base.log-Tuple{Number,Number})
...
* [`Base.log2` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.log2)
* [`Base.log10` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.log10)
