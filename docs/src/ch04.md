...
### ラジアン単位
* [`Base.tan` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.tan-Tuple{Number})
* [`Base.cot` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.Math.cot-Tuple{Number})
...
### 角度単位
* [`Base.Math.tand` - Function](hhttps://docs.julialang.org/en/v1.5/base/math/#Base.Math.tand)
* [`Base.Math.cotd` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.Math.cotd)
...
[`Base.sign` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.sign)
...
* [`Base.abs` - Function](https://docs.julialang.org/en/v1.5/base/math/#Base.abs)
...
[`Base.Math.clamp`](https://docs.julialang.org/en/v1.5/base/math/#Base.Math.clamp)
...
* [`Base.floor`](https://docs.julialang.org/en/v1.5/base/math/#Base.floor)
* [`Base.ceil`](https://docs.julialang.org/en/v1.5/base/math/#Base.ceil)
