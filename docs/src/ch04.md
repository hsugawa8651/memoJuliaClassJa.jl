...
plt.savefig("ch04-recipro2-plot.svg"); nothing #hide
plt.close("all"); nothing #hide
```
...
plt.axvline(-3, color="k", lw=0.5)
plt.axvline(2, color="k", lw=0.5)
plt.savefig("ch04-dis2-plot.svg"); nothing #hide
plt.close("all"); nothing #hide
```
...
plt.axvline(-2, color="k", lw=0.5)
plt.axvline(2, color="k", lw=0.5)
plt.savefig("ch04-dis3-plot.svg"); nothing #hide
plt.close("all"); nothing #hide
```
...
plt.xlabel("radian")
plt.legend()
plt.savefig("ch04-tan1-plot.svg"); nothing #hide
plt.close("all"); nothing #hide
```
...
plt.ylim(-1e1, 1e1)
plt.legend()
plt.savefig("ch04-tan2-plot.svg"); nothing #hide
plt.close("all"); nothing #hide
```
...
plt.xlabel("radian")
plt.legend()
plt.savefig("ch04-tan1t-plot.svg"); nothing #hide
plt.close("all"); nothing #hide
```
...
xs=-6.4:0.1:6.4
plt.plot(xs, sign.(xs), ".")
plt.savefig("ch04-sign1-plot.svg"); nothing #hide
plt.close("all"); nothing #hide
```
...
plt.legend()
plt.savefig("ch04-sign2-plot.svg"); nothing #hide
plt.close("all"); nothing #hide
```
...
Jupyter notebookの Markdownセルを用いて、説明文も加えよ。
